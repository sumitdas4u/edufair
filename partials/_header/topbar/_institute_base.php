...
<div class="kt-header__topbar">
	<?php /* include_once('partials/_header/topbar/_search.php'); */?>
	<!--[html-partial:include:{"file":"partials/_header/topbar/_search.html"}]/-->
    <?php  include_once('partials/_header/topbar/_institute_notifications.php'); ?>
   ...
   <!-- --><?php /* include_once('partials/_header/topbar/_quick-panel.php'); */?>
	...
	<?php  include_once('partials/_header/topbar/_institute_user.php'); ?>
