<?php
if(!$user_logged_in->token->token) header("Location: login"); //check user is logged in with session header


//every request we check the token is valihnjgfvbd not expired
/*$ch = curl_init();
$authorization = "Authorization: Bearer". $_SESSION['user_login_token'];
curl_setopt($ch, CURLOPT_HTTPHEADER, array($authorization ));
curl_setopt($ch, CURLOPT_URL, 'http://api.edufaironline.com/auth/validtoken');
...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-page--loading">
        ...
        <!--begin::Page Scripts(used by search modal window to select) -->
		...
		<!--end::Chat Scripts -->
                ...
                <script src="assets/js/pages/custom/chat/moment.js" type="text/javascript"></script>
